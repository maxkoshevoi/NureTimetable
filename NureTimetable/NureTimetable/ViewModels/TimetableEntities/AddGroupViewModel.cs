...
namespace NureTimetable.ViewModels.TimetableEntities
{
    public class AddGroupViewModel : BaseViewModel
    {
        ...
        private List<SavedEntity> _savedGroups;
        ...
        private async Task GroupSelected(Group group)
        {
            ...
            _savedGroups.Add(new SavedEntity(group));
            UniversityEntitiesRepository.UpdateSaved(_savedGroups);
        ...
        private async Task UpdateGroups(bool fromCistOnly = false)
        {
            ...
            await Task.Factory.StartNew(() =>
            {
                ...
                _allGroups = UniversityEntitiesRepository.GetAllGroups().ToList();
                ...
                _savedGroups = UniversityEntitiesRepository.GetSaved();
                Groups = new ObservableCollection<Group>(_allGroups.OrderBy(g => g.Name));
