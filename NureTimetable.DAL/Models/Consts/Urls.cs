...
namespace NureTimetable.DAL.Models.Consts
{
    public static class Urls
    {
        ...
        public static Uri CistSiteAllGroups(long? facultyId)
            => new Uri($"http://cist.nure.ua/ias/app/tt/WEB_IAS_TT_AJX_GROUPS?p_id_fac={facultyId}");

        public static Uri CistSiteAllTeachers(long facultyId = -1, long kafId = -1)
            => new Uri($"https://cist.nure.ua/ias/app/tt/WEB_IAS_TT_AJX_TEACHS?p_id_fac={facultyId}&p_id_kaf={kafId}");
    }
}
